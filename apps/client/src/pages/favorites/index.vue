...
.empty { margin-top: 48px; text-align: center; color: #94a5ab; line-height: 1.8; }
.card { margin-top: 14px; border-radius: 19px; background: white; border: 1px solid #eef1ef; padding: 16px; }
